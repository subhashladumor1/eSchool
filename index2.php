...
<body>
            ...
            <div class="btn">
                <?php
                    if (!isset($_SESSION['is_login'])) {
                        echo '<a href="#" class="blue" data-toggle="modal" data-target="#stuRegModalCenter">Get
                        Started</a>';
                    } else {
                        echo '<a href="Student/studentProfile.php" class="blue"> My Profile</a>';
                    }
                ?>
    ...
    <section id="experts">
        ...
        <div class="expert-box">
            ...
            <div class="profile">
                <img src="images/SL.jpg" width="200" height="200" alt="">
            ...
            <div class="profile">
                <img src="images/NV.jpg" width="200" height="200" alt="">
                <h6>Ninad Virani</h6>
                <p>BCA student</p>
                <div class="pro-links">
                    <i class="fa-brands fa-facebook"></i>
            ...
            <div class="profile">
                <img src="images/BJ.jpg" width="200" height="200" alt="">
                <h6>Bharat Jhawar</h6>
                <p>BCA student</p>
                <div class="pro-links">
                    <i class="fa-brands fa-facebook"></i>
