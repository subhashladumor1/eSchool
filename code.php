...
<body style="position:relative;min-height:100%;font-family: 'Source Sans Pro', sans-serif;">
  ...
  <!-- <div style='display:none;position:absolute;z-index:6;top:75px;right:0;height:75px;padding-top:22px;padding-right:20px;padding-left:20px;;' id='googleSearch'>
  ...
  <div class="w3-main" id="main">
    ...
    <!-- <div class="ws-black w3-center" style="padding-top:90px;padding-bottom:90px;">
      <div class="w3-content learntocodecontent" style="max-width:1400px">
        <P class="learntocodeh1">Learn to Code</p>
        <br>
      </div>
    </div> -->
    ...
    <div class="w3-row w3-padding-32 " style="margin-top:-10px">
      <div class="w3-content" style="max-width:1400px">
        ...
        <div class="w3-col l6 w3-center" style="padding:3%;">
          ...
          <a href="ide.php" class="btn blue" style="margin-bottom:2px;">Learn HTML</a><br>


        </div>
        <div class="w3-col l6 " style="padding:3%">
          <div class="w3-hide-small ws-light-green grey-color w3-card-2 w3-round" style="padding:16px;">
            <h3>HTML Example:</h3>
            ...
            <a href="ide.php" target="_blank" class="btn blue">Try it Yourself</a>
          </div>
        </div>
      </div>
    </div>
    <hr style="border:5!important;">
    <div class="w3-row w3-padding-32 ">
      <div class="w3-content" style="max-width:1400px">
        <div class="w3-col l6 w3-center" style="padding:3%">
          <h1 style="font-size:100px;font-weight:700">CSS</h1>
          <p style="font-size:19px;">The language for styling web pages</p>
          <a href="ide.php" class="btn blue">Learn CSS</a><br>

        </div>
        <div class="w3-col l6 " style="padding:3%">
          <div class="w3-hide-small ws-yellow grey-color w3-card-2 w3-round" style="padding:16px;">
            <h3>CSS Example:</h3>
    ...
    <div class="w3-row w3-padding-32 ">
      <div class="w3-content" style="max-width:1400px">
        <div class="w3-col l6 w3-center" style="padding:3%">
          ...
          <a href="ide.php" class="btn blue">Learn JavaScript</a><br>

        </div>
        <div class="w3-col l6" style="padding:3%">
          <div class="w3-hide-small w3-card-2 ws-black grey-color w3-round" style="padding:16px;">
