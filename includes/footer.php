...
<div class="modal fade" id="stuLoginModalCenter" role="dialog" aria-labelledby="stuLoginModalCenterLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form id="stuLoginForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Email" name="stuLogemail" id="stuLogemail">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <a href="forgot-password.php" style="text-decoration: none;">Forget Password</a>
                    </div>
                </form>
...
<!-- *********** Start Student Reset Password Email Check Form Modal *************** -->

<div class="modal fade" id="sentEmailModalCenter" role="dialog" aria-labelledby="sentEmailModalCenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="sentEmailModalCenter">Password Reset</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <!-- ****************** Start Reset Password Sent Form ******************* -->
                
                <form id="sentEmailForm" action="password_reset_p1.php" method="POST">

                    <div class="form-group">
                        <i class="fas fa-envelope"></i><label for="sentEmail" class="pl-2 font-weight-bold">Email</label>
                        <input type="text" class="form-control" placeholder="Enter Email" name="sentEmail" id="sentEmail">
                    </div>


                    <!-- ****************** End Reset Password Sent Form ******************* -->
            </div>
            
            <div class="modal-footer">
                <small id="statusLogMsg"></small>
                <button type="submit" name="sentEmailBtn" class="btn btn-primary" id="sentEmailBtn">Send Password Reset Link</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            </div>
            </form>
            ...
            <div class="modal-body">
                ...
                <form id="adminLoginForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Email" name="adminLogemail" id="adminLogemail">
                    </div>
                    <div class="form-group">
                        <i class="fas fa-key"></i><label for="adminLogpass" class="pl-2 font-weight-bold">Password</label>
                        <input type="password" class="form-control" placeholder="Enter Passoword" name="adminLogpass" id="adminLogpass">
                    </div>
                </form>
